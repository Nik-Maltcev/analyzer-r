...
def main():
    ...
    conn.execute("""
        CREATE TABLE IF NOT EXISTS pairs (
            ...
            corr REAL, halflife INTEGER, t_stat REAL,
            coint_pvalue REAL, coint_critical_5pct REAL, is_coint INTEGER,
            hedge_ratio REAL, ar_phi REAL, spread_sd_pct REAL,
            backtest_trades INTEGER DEFAULT 0, backtest_win_rate REAL,
            backtest_avg_pnl_pct REAL, backtest_avg_pnl_sigma REAL,
            backtest_avg_hold_days REAL,
            backtest_validated INTEGER DEFAULT 0,
            score REAL, z_now REAL, z_forecast REAL,
    ...
    conn.execute("""
        CREATE TABLE IF NOT EXISTS favorites (
            ...
            taker_fee_pct_at_entry REAL, funding_rate_pct_at_entry REAL,
