...
CREATE TABLE IF NOT EXISTS short_term_hourly_candles (
    ticker        TEXT NOT NULL,
    open_time     INTEGER NOT NULL,
    open          REAL NOT NULL,
    high          REAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS short_term_perp_candles (
    ticker        TEXT NOT NULL,
    open_time     INTEGER NOT NULL,
    open          REAL NOT NULL,
    high          REAL NOT NULL,
